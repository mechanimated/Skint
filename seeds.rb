...
= Ingredient.create(name: "", chem_type: "", treatment: "")



puts "Creating Product..."

skinceuticals_cleanser = Product.create(name: "Soothing Cleanser", brand: "Skinceuticals", price: "$36", ingredients: ["sorbitol", "glycerin", "propylene_glycol", "ascorbic_acid"])
# sorbitol, glycerin, propylene glycol, ascorbic acid, https://www.skinceuticals.com/soothing-cleanser-3606000463660
byoma_hydrating_serum = Product.create(name: "Hydrating Serum Tri-Ceramide Complex", brand: "BYOMA", price: "$15.99", ingredients: ["glycerin", "ceramide", "squalane", "butelyne_glycol", "lactic acid"])
# glycerin, ceramide, squalane, butelyne glycol, lactic acid  https://byoma.com/product/hydrating-serum/
olay_regenerist = Product.create(name: "Regenerist Micro-Sculpting Cream", brand: "Olay", price: "$36.99", ingredients: ["glycerin", "niacinamide", "sodium_hyaluronate", "isohexadecane"])
...
vichy_liftactiv= Product.create(name: "LiftActiv Peptide-C Face Sunscreen", brand: "Vichy", price: "$39", ingredients: ["glycerin", "dimethcone", "glycolic acid", "sodium hyaluronate", "stearic acid", "avobenzone", "homosalate", "octisalate", "octocrylene"])
...
cerave_sa_cleanser = Product.create(name: "Renewing SA Cleanser", brand: "CeraVe", price: "$11.49", ingredients: ["glycerin", "ceramide", "salicylic_acid", "niacinamide", "hyaluronic_acid"])
...
ordinary_glycolic_toner = Product.create(name: "Glycolic Acid 7% Exfoliating Toning Solution", brand: "The Ordinary", price: "$10", ingredients: ["glycolic acid"])
# glycolic acid https://www.sephora.com/product/the-ordinary-deciem-glycolic-acid-7-toning-solution-P427406
br_lotion50 = Product.create(name: "Lotion P50", brand: "Biologique Recherche", price: "$34", ingredients: ["citric_acid", "lactic_acid", "malic_acid", "salicylic_acid", "gluconolactone", "niacinamide"])
...
laroche_retinol = Product.create(name: "Pure Retinol Face Serum with Vitamin B3", brand: "La Roche-Posay", price: "39.99", ingredients: ["glycerin", "niacinamide", "dimethicone", "sodium_hyaluronate", "retinol", "citric_acid"])
...
ordinary_retinol = Product.create(name: "Retinol 1% in Squalane", brand: "The Ordinary", price: "$8.00", ingredients: ["squalane", "retinol"])
# squalane, retinol https://theordinary.com/en-us/retinol-1-in-squalane-serum-100441
= Product.create(name: "", brand: "", price: "")
= Product.create(name: "", brand: "", price: "")

puts "Creating Interactions..."

ret_aha = Interaction.create(warning: "Retinols and AHAs used together are likely to cause redness and flaking.", cause1: "vitamin A", cause2: "alpha-hydroxy acid")
